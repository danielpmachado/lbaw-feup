...
INSERT INTO "user" (id,email,username,password,address,city,zip,permissions,blocked) VALUES (DEFAULT,'vel.est.tempor@google.pt','admin_lbaw','PDB77ZTR5OS','Ap #894-4328 Erat Road', 'Raiganj','5370-253','Admin',0);
...
INSERT INTO "user" (id,email,username,password,address,city,zip,permissions,blocked) VALUES (DEFAULT,'Nulla.facilisi@semeget.org','Charity Livingston','QYA36FRM1NX','9785 Neque St.','Ambala Sadar','5370-253','Admin',0);
...
INSERT INTO "user" (id,email,username,password,address,city,zip,permissions,blocked) VALUES (DEFAULT,'egestas@diam.edu','Quinn Barnes','IBH69AXY9UU','Ap #515-4663 Nulla Street','Melsele','5370-253','Admin',0);
...
INSERT INTO "user" (id,email,username,password,address,city,zip,permissions,blocked) VALUES (DEFAULT,'feugiat@pedeSuspendisse.com','Cole Tyson','ONK78OZF8JP','202-214 Lorem Ave','Montpellier','5370-253','Admin',0);
...
INSERT INTO "user" (id,email,username,password,address,city,zip,permissions,blocked) VALUES (DEFAULT,'nibh.vulputate@est.com','Isaac Dillard','SDJ96YDP4PD','Ap #123-9516 Augue. St.','Ramsel','5370-253','Admin',0);
INSERT INTO "user" (id,email,username,password,address,city,zip,permissions,blocked) VALUES (DEFAULT,'fringilla.purus.mauris@anequeNullam.org','Hayes Mcpherson','SJG98OFJ0XY','2765 Mi Rd.','Hawick','5370-253','Admin',0);
INSERT INTO "user" (id,email,username,password,address,city,zip,permissions,blocked) VALUES (DEFAULT,'Suspendisse.aliquet.molestie@atvelit.com','Sydney Mcfadden','QQO20CHT9RF','9359 Lorem Av.','Richmond','5370-253','Admin',0);
...
INSERT INTO "user" (id,email,username,password,address,city,zip,permissions,blocked) VALUES (DEFAULT,'scelerisque.lorem.ipsum@Maurisquisturpis.org','Tatum Simpson','SHD63JUZ3FH','3972 Sit Rd.','Salem','5370-253','Admin',0);
...
INSERT INTO product (id,name,description,stock,price,id_brand,pic,id_category,score) VALUES (DEFAULT,'SDXC KINGSTON 128GB CANVAS REACT 1','Capacidade128 GB, Classe da Memória FlashClass 10, Velocidade de leitura (máx.) 100MB/s, Velocidade de Escrita (máxima)70MB/s, Peso 0,01, Cor black', 33, 84.99, 18, 'kingston-128gb.png', 5, 3);

INSERT INTO product (id,name,description,stock,price,id_brand,pic,id_category,score) VALUES (DEFAULT,'IPhone 8 Plus 256GB Dourado','smartphone com capacidade de armazenamento de 256 GB, e ecrã LCD Retina HD de 5,5” (1920 x 1080 píxeis); tecnologias True Tone e 3D Touch; vidro extra-resistente e contorno em alumínio de qualidade aeroespacial; carregamento sem fios; revestimento oleofóbico; Touch ID; processador A11 Bionic com arquitetura de 64 bits; vídeo 4K até 60 fps; câmaras de 12 e 7 MP.', 25, 1119.99, 3, 'iphone8.png',3,3);
...
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,1,'Yet one that really paid off six months into our testing.One that was sorely needed after years of similarity and the premium design, extra power.Losing the home button and altering the design was a dangerous move.','2018-02-10',1,10);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,1,'It is a very decent laptop with a nice and very bright ips screen. The hardware is mostly made out of good plastic materials and aluminum details. The touchpad is accurate and has upgradable ram. Very happy with this deal i made.','2017-08-10',12,3);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,3,'A bateria é um elemento em destaque, mas pela negativa. A autonomia da empresa está estimada em cinco horas, mas a verdade é que num nível de utilização exigente o computador pode não render muito mais do que três horas.','2018-01-05',8,14);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,5,'Simplesmente incrível','2018-08-10',16,12);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,5,'Melhor consola','2018-08-10',17,16);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,5,'Top','2017-12-26',19,20);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,3,'Amei o móvel por enquanto é o melhor que já usei a minha opinião é que é melhor que o iPhone X','2017-08-10',4,12);
...
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,1,'It is impossible to give a perfect score to something that costs this much - but this is the closest to smartphone perfection Apple has ever got.','2018-08-10',22,9);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,5,'Comprei para o meu filho, ele adorou. Não o larga o dia todo','2016-08-10',10,4);
...
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,3,'Too expensive','2017-08-13',2,3);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,5,'A melhor','2018-02-01',19,7);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,2,'Para o preço esperava melhor. Desilusão','2018-04-10',13,12);
...
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,5,'PS4 for life','2018-02-1',17,3);
...
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,3,'Este VivoSmart S410UN oferece, num corpo verdadeiramente compacto e elegante, uma máquina preparada para lidar com todas as tarefas do dia-a-dia de forma competente. Infelizmente o mesmo não se pode dizer da autonomia, algo limitada para quem precise de um equipamento para viajar.','2016-09-19',14,19);
INSERT INTO review (id,score,comment,date,id_product,id_user) VALUES (DEFAULT,1,'Não troco a minha PS4 por isto','2018-03-29',18,6);
